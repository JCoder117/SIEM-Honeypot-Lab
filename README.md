...
<br />
Observe the wiped disk:  <br/>
<img src="8. enablement of the ability to gather logs from the vm into the log analytics workspace law.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<br />
Observe the wiped disk:  <br/>
